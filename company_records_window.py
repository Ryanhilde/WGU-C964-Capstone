...
from comapny_hash_map import Company_HashMap
import numpy as np
import csv
import random
...
def company_country_vales():
    company_array = np.arange(1, 101)
    company_country_array = [None]
    for i in range(len(company_array)):
        try:
            result = random.randint(1, 1000)
            company_country_array[i] = get_hash_map().get(str(result))[3]
        except IndexError:
            pass
...
def company_data_filter_one_names(data_to_be_filtered, index, updated_field):
    ...
    if result == 0:
        ...
        if result == 0:
            ...
            data_to_be_filtered = company_name_values()
            get_hash_map().get(str(index))[updated_field] = data_to_be_filtered
            update_noise_counter_one()


def company_data_filter_one_countries(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
        ...
        if result == 0:
            ...
            data_to_be_filtered = company_country_vales()
            get_hash_map().get(str(index))[updated_field] = data_to_be_filtered
            update_noise_counter_one()


def company_data_filter_one_values(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
...
def company_data_filter_two_names(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
...
def company_data_filter_two_countries(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
...
def company_data_filter_two_values(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
...
class Ui_MainWindow_Company(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DP_button.setText(_translate("MainWindow", "Apply Differential Privacy Filtering"))
    ...
    def pressed(self):
        ...
        try:
            if first_company_filter == "Name":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        company_data_filter_one_names(get_hash_map().get(str(test_array[i]))[1], test_array[i],
                                                      field_to_be_updated_one)
                self.first_data_set_label.setText("Change applied to first data set: " + "{:.2%}".format(
                    int(update_noise_counter_one()) / len(test_array)))
            if first_company_filter == "Country":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        company_data_filter_one_countries(get_hash_map().get(str(test_array[i]))[1], test_array[i],
                                                      field_to_be_updated_one)
                self.first_data_set_label.setText("Change applied to first data set: " + "{:.2%}".format(
                    int(update_noise_counter_one()) / len(test_array)))
            if first_company_filter == "Value":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        company_data_filter_one_values(get_hash_map().get(str(test_array[i]))[1], test_array[i],
                                                       field_to_be_updated_one)
                self.first_data_set_label.setText("Change applied to first data set: " + "{:.2%}".format(
                    int(update_noise_counter_one()) / len(test_array)))
            if second_company_filter == "Name":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        company_data_filter_two_names(get_hash_map().get(str(test_array[i]))[3], test_array[i],
                                                      field_to_be_updated_two)
                self.second_data_set_label.setText("Change applied to second data set: " + "{:.2%}".format(
                    int(update_noise_counter_two()) / len(test_array)))
            if second_company_filter == "Country":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        company_data_filter_two_countries(get_hash_map().get(str(test_array[i]))[3], test_array[i],
                                                      field_to_be_updated_two)
                self.second_data_set_label.setText("Change applied to second data set: " + "{:.2%}".format(
                    int(update_noise_counter_two()) / len(test_array)))
            if second_company_filter == "Value":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        company_data_filter_two_values(get_hash_map().get(str(test_array[i]))[3], test_array[i],
                                                          field_to_be_updated_two)
                self.second_data_set_label.setText("Change applied to second data set: " + "{:.2%}".format(
                    int(update_noise_counter_two()) / len(test_array)))
            ...
            altered_data = "Write_Company_Data.csv"
