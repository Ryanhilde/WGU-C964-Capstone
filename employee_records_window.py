...
def employee_name_values():
    ...
    for i in range(len(employee_array)):
        try:
            ...
            employee_name_array[i] = get_hash_map().get(str(result))[1]
        except IndexError:
            pass
...
def employee_email_vales():
    ...
    for i in range(len(employee_array)):
        try:
            result = random.randint(1, 1000)
            employee_name_array[i] = get_hash_map().get(str(result))[3]
        except IndexError:
            pass
    format_list = str(employee_name_array)[2:-2]
    return format_list
...
def employee_data_filter_one_emails(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
        ...
        if result == 0:
            ...
            data_to_be_filtered = employee_email_vales()
            get_hash_map().get(str(index))[updated_field] = data_to_be_filtered
            update_noise_counter_one()
...
def employee_data_filter_two_emails(data_to_be_filtered, index, updated_field):
    result = random.randint(0, 1)
    if result == 0:
        pass
    else:
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_menu_text.setText(_translate("MainWindow", "To view the altered employee records dataset, go back to the main menu"))
            ...
            if first_employee_filter == "First Name":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        employee_data_filter_one_names(get_hash_map().get(str(test_array[i]))[1], test_array[i],
            ...
            if first_employee_filter == "Email":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        employee_data_filter_one_emails(get_hash_map().get(str(test_array[i]))[1], test_array[i],
                                                   field_to_be_updated_one)
                self.first_data_set_label.setText("Change applied to first data set: " + "{:.2%}".format(
                    int(update_noise_counter_one()) / len(test_array)))
            if second_employee_filter == "First Name":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        employee_data_filter_two_names(get_hash_map().get(str(test_array[i]))[3], test_array[i],
            ...
            if second_employee_filter == "Email":
                ...
                for i in range(len(test_array)):
                    if i == 0:
                        ...
                        employee_data_filter_two_emails(get_hash_map().get(str(test_array[i]))[3], test_array[i],
                                                   field_to_be_updated_two)
                self.second_data_set_label.setText("Change applied to second data set: " + "{:.2%}".format(
                    int(update_noise_counter_two()) / len(test_array)))
